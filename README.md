...
![Easy Tailscale Server screenshot](assets/screenshot.png)
...
- This is not an official Tailscale app and is not affiliated with Vultr, DigitalOcean, Hetzner, Flatcar, or Tailscale.
